...
class TrainedPolicyConfig:
    ...
    def save_to_file(self):
        ...
        if self.minari_dataset_config.initial_config_2d_grid_env is not None:
            obj_to_save["minari_dataset_config"]["initial_config_2d_grid_env"]["obstacles"] = \
                obj_to_save["minari_dataset_config"]["initial_config_2d_grid_env"]["obstacles"].value
    ...
    def load_from_file(cls, dataset_id):
        ...
        config_dict["minari_dataset_config"] = MinariDatasetConfig.from_dict(config_dict["minari_dataset_config"])
        return cls(**config_dict)
