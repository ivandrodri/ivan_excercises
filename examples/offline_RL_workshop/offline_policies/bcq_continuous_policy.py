...
from tianshou.utils.net.continuous import Perturbation, Critic, VAE
...
def create_bcq_continuous_policy_from_dict(policy_config:Dict[str,Any], action_space:gym.core.ActType,
    ...
    #ToDo --> may be replace observation_shape --> observation_space.shape (idem with action_shape)
    net_c1 = Net(
        observation_shape,
        action_shape,
        hidden_sizes=policy_config["hidden_sizes"],
