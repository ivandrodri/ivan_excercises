...
config = {
    "NAME_ENV": "AdroitHandRelocate-v1",
...
EPOCH = 1
BATCH_SIZE = 256#32
UPDATE_PER_EPOCH = 80 #100000
STEP_PER_COLLECT = 128#10
...
policy.load_state_dict(torch.load(os.path.join(log_path, config["POLICY_NAME"]), map_location="cpu"))
